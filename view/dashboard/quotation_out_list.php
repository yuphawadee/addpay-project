...
if (isset($_GET["deletequo"])) {
    ...
    if ($query) {
        $_SESSION['success'] = "ลบใบเสนอราคาออกสำเร็จ!";
...
<div class="container bg-secondary-addpay rounded-5">
    <div class="main-body py-md-2 px-md-1 text-white">
        <div class="container">
            <div id="listquotation" class="py-4 p-md-5 text-white">
                ...
                $(document).ready(function() {
                    ...
                    $(document).on('click', '.deletequo', function() {
                        ...
                        swal.fire({
                            title: 'ต้องการลบใบเสนอราคาออกนี้ !',
                            text: "เลขที่ใบเสนอราคาออก : " + show_quo_no,
                            type: 'warning',
